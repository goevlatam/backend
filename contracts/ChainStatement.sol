...
contract ChainStatement is Ownable {
    ...
    modifier onlyRelayer() {
        ...
        require(
            ...
            "should be address from relayer"
        );
        _;
    }
    ...
    function addNewUser(uint256 identityCommitment, address userAddr)
        external
        onlyRelayer
    {
        //Uncomment this
...
**/
    ...
    function getAddresses(uint256 identityCommitment)
        public
        view
        onlyRelayer
    ...
    {
        require(
            block.timestamp <= claimWindow[identityCommitment],
            "should wait for more than 2 minutes to claim the statement!"
        );
        return userAddresses[identityCommitment];
    }

    function getTimeStamp(uint256 identityCommitment)
        external
        view
